<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    function remote_storage($url) {
        return ($pos = strpos($url, '/public/')) !== false ? substr_replace($url, '/', strpos($url, '/public/', $pos + 1), strlen('/public/')) : $url;
    }
    @endphp
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-stack fs-4 py-3">
                                ...
                                {{-- @dd($user->is_approved) --}}
                                @if ($user->is_bpo_approved !== 1)
                                <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Approve as BPO">
                                    <button wire:click="changeBPOStatus(1)" class="btn btn-sm btn-light-primary">Approve Now</button>
                                    {{-- <a href="#" wire:click="changeBPOStatus(1)" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_update_details">Approve Now</a> --}}
                                </span>
                                @else
                                <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Dispprove as BPO">
                                    <a href="#" wire:click="changeBPOStatus(0)"  class="btn btn-sm btn-light-danger" data-bs-toggle="modal" data-bs-target="#kt_modal_update_details2">Disapprove</a>
                                </span>
                                @endif
                            </div>
                            <!--end::Details toggle-->
                            ...
                            <div class="card pt-4 mb-6 mb-xl-9">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form" id="kt_users_email_notification_form">
                                        <!--begin::Item-->
                                        <!--begin::Item-->
                                        @forelse($user_files as $key => $ufile)
                                        
                                        <div class="d-flex">
                                            <!--begin::Checkbox-->
                                            {{-- preg_replace('/\/public\//', '/', $url, 1) --}}
                                            <a href="{{ remote_storage('http://localhost/eco-auth/public/storage/'.$ufile->path ) }}" class="form-check form-check-custom form-check-solid">
                                                <!--begin::Input-->
