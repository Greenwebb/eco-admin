...
<div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack flex-wrap">
        ...
        <div class="page-title d-flex flex-column me-5 py-2">
            <!--begin::Title-->
            <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">{{ $user[0]->name }}</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">{{ $user[0]->name }}</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-center flex-column py-5">
                            ...
                            <!--end::Avatar-->
                            <!--begin::Name-->
                            <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3  text-uppercase">{{ $user[0]->name }}</a>
                            <!--end::Name-->
                            <!--begin::Position-->
                            <div class="mb-9">
                                <!--begin::Badge-->
                                {{-- <div class="badge badge-lg badge-light-primary d-inline text-uppercase">{{ $user[0]->type }}</div> --}}
                                <!--begin::Badge-->
                            </div>
                            <!--end::Position-->
                            <!--begin::Info-->
                        ...
                        <div id="kt_user_view_details" class="collapse show">
                            <div class="pb-5 fs-6">
                                ...
                                <div class="text-gray-600">ID-{{ $user[0]->id }}</div>
                                <!--begin::Details item-->
                                <!--begin::Details item-->
                                <div class="fw-bold mt-5">Email</div>
                                <div class="text-gray-600">
                                    <a href="#" class="text-gray-600 text-hover-primary">{{ $user[0]->email }}</a>
                                </div>
                                <!--begin::Details item-->
                                <!--begin::Details item-->
                                <div class="fw-bold mt-5">Address</div>
                                <div class="text-gray-600">
                                    {{ App\Models\User::details($user[0]->id) !== null ?  App\Models\User::details($user[0]->id)->province : ''}}
                                    {{ App\Models\User::details($user[0]->id) !== null ?  App\Models\User::details($user[0]->id)->city : ''}}
                                </div>
                                <!--begin::Details item-->
                                <!--begin::Details item-->
                                ...
                                <div class="text-gray-600">{{ App\Models\User::details($user[0]->id) !== null ?  App\Models\User::details($user[0]->id)->phone_number : ''}}</div>

                                <div class="fw-bold mt-5">Provider</div>
                                <div class="text-gray-600">{{ App\Models\User::details($user[0]->id) !== null ?  App\Models\User::details($user[0]->id)->service : ''}} Service Provider</div>
                        ...
                        <div class="card pt-4 mb-6 mb-xl-9">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form" id="kt_users_email_notification_form">
                                    <!--begin::Item-->
                                    <!--begin::Item-->
                                    @forelse($user[0]->user_files as $key => $ufile)
